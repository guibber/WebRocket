...
namespace WebRocketTests.Server {
  ...
  public class RocketTests : BaseUnitTest {
    ...
    public void DoSetup() {
      ...
      mSocket = Mock<IWebSocket>();
      mContext = Mock<IHttpListenerWebSocketContext>();
      mContext.SetupGet(m => m.WebSocket).Returns(mSocket.Object);
      mRocket = new Rocket(mContext.Object);
    }
    ...
    private Mock<IHttpListenerWebSocketContext> mContext;
    private Mock<IWebSocketReceiveResult> mResult;
    private Mock<IWebSocket> mSocket;
  }
}